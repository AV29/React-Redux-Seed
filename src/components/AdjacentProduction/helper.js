export const matrix = [
  ...
  ['99', '34', '20', '97', '38', '25', '39', '11', '24', '94', '72', '18', '08', '46', '29', '32', '40', '62', '76', '36'],
  ['12', '69', '36', '41', '72', '30', '23', '88', '34', '62', '99', '69', '82', '67', '59', '85', '74', '04', '36', '16'],
  ['13', '73', '35', '29', '78', '31', '90', '01', '74', '31', '49', '71', '48', '86', '81', '16', '23', '57', '05', '54'],
      ...
      for (let k = 0; k < lim; k += 1) {
        ...
        for (let n = 0; n < directionsMap.length; n += 1) {
          ...
          if (isIndexCorrect(x, y)) {
            vectors[n].res *= parseInt(data[x][y]);
